...
struct ListNode* mergeTwoLists(struct ListNode* list1, struct ListNode* list2) {
    ...
    struct ListNode merged_list_psuedo_head;
    struct ListNode* merged_list_current_node = &merged_list_psuedo_head;
    ...
    while (
        ...
        if ((list1_current_node_ptr->val) <= (list2_current_node_ptr->val)) {
             ...
             */
            merged_list_current_node->next = list1_current_node_ptr;
            merged_list_current_node = list1_current_node_ptr;
             ...
             */
            merged_list_current_node->next = list2_current_node_ptr;
            merged_list_current_node = list2_current_node_ptr;
    ...
    return (merged_list_psuedo_head.next);
}

...
class UnionFindDS:
    ...
    def find(self, i: int) -> int:
        ...
        if i == (self._parents_list[i]):
            return i

        # Do path compresion to make the i-th slot point to the
        # root directly.
        self._parents_list[i] = self.find(self._parents_list[i])

        return self._parents_list[i]

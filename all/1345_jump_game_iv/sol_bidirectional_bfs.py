...
class Solution:
    def minJumps(self, arr: List[int]) -> int:
        ...
        bfs_info_dict['left']['indices_visited_list'][0] = True
        ...
        # Mark the last index as visited.
        bfs_info_dict['right']['indices_visited_list'][arr_length - 1] = True
